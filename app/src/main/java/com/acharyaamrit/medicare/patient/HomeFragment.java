...
import com.acharyaamrit.medicare.patient.adapter.patienthomepageadapter.AfternoonAdapter;
import com.acharyaamrit.medicare.patient.adapter.patienthomepageadapter.EveningAdapter;
import com.acharyaamrit.medicare.patient.adapter.patienthomepageadapter.MorningAdapter;
import com.acharyaamrit.medicare.patient.adapter.patienthomepageadapter.NightAdapter;
...
import com.acharyaamrit.medicare.patient.model.patientModel.Medicine;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.viewAll).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(requireContext(), UserTimelineActivity.class);
                startActivity(intent);
            }
        });

        view.findViewById(R.id.timelineMain).setVisibility(GONE);
